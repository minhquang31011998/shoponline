    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="" style="margin: 0;font-size: 26px;">Danh sách sản phẩm</h3>
                <div class="clearfix"></div>
                <a href="#add" class="btn btn-success" style="margin:10px 0px;" data-toggle="modal">Thêm mới</a>    
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div id="form-step-0" role="form" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                        <label for="">Teemn sản phẩm</label>
                ...
                <div class="container-fluid">
                 ...
                 <div class="row">
                    <div class="col-sm-10 offset-sm-1">
                        <h2 class="page-heading">Ảnh sản phẩm <span id="counter"></span></h2>
