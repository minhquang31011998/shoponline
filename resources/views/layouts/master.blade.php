...
<html lang="en">
<head>
	<title>Shop LAPTOP & CAMERA</title>
	<meta charset="UTF-8">
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<span class="header-cart-item-info">
								Ram: {{$row->options->size}} - Color: {{$row->options->color}} - ${{$row->price}} - x{{$row->qty}}
							</span>
						</div>
					</li>
					@endforeach
...
<div class="fb-customerchat"
  ...
  page_id="1207241749455684"
  logged_in_greeting="Hello ! Shop CHT xin chào"
  logged_out_greeting="Hello ! Shop CHT xin chào">
</div>
	...
	<script>
		...
		$('.js-addwish-b2').each(function(){
			...
			$(this).on('click', function(){
				swal(nameProduct, "Cảm ơn bạn đã thích sản phẩm", "success");
