...
class ProductDetailManagerController extends Controller
{
	public function getDetail($product_id,$btn_id)
	{
		...
		->addColumn('action',function($details){
			return '
			<a class="btn btn-warning detail-edit" data-id="'.$details->id.'"​ data-toggle="tooltip" title="Sửa sản phẩm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
			<button class="btn btn-danger detail-delete" data-id="'.$details->id.'"​ data-toggle="tooltip" title="Xóa"><i class="fa fa-trash-o" aria-hidden="true"></i></i></button>';
