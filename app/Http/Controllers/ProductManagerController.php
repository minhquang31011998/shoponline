...
class ProductManagerController extends Controller
{
	...
	public function getdata()
	{
		...
		->addColumn('action', function($product){
			return '
			<a href="#" class="btn btn-primary btn-detail"  data-id="'.$product->id.'"​ data-toggle="tooltip" title="Thêm chi tiết sản phẩm" ><i class="fa fa-eye" aria-hidden="true"></i> </a>
			
			<a class="btn btn-warning btn-edit" data-id="'.$product->id.'"​ data-toggle="tooltip" title="Sửa sản phẩm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
			
			<button class="btn btn-danger btn-delete" data-id="'.$product->id.'"​ data-toggle="tooltip" title="Xóa sản phẩm"><i class="fa fa-trash-o" aria-hidden="true"></i></i></button>';
